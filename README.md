# Dictionary for kpv — rus

This repository contains source files for a dictionary from Komi-Zyrian to Russian. The content is licensed under the CC-BY-4.0 license.
